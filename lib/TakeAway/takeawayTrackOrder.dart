...
class TakeawayTrackOrder extends StatefulWidget {
  TakeawayTrackOrder({Key? key, required this.latLong}) : super(key: key);

  LatLng latLong;


  @override
  State<TakeawayTrackOrder> createState() => _TakeawayTrackOrderState();
}

class _TakeawayTrackOrderState extends State<TakeawayTrackOrder>{
