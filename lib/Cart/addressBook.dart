...
class _AddressBookState extends State<AddressBook>{
  ...
  void initState() {
    ...
    apiService.getAddresses().then((value) {
      setState(() {
        addressModel = value;
        print('AddressModelLength------------------------${addressModel!.length}');
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: ()async {
                    ...
                    await prefs.setBool('isComeFromAddressBook', true);
                            ...
                            onTap: () {
                              Navigator.push(context,
                                  AnimatedRoute.createRouteRightToLeft(
                                      CartOrderPlace(latLong: _userLatLong)));
                            },
  ...
  Widget _buildAddressItem(AddressModel addressM){
    AppFontSizes fontSizes = AppFontSizes(context);
    String? fullAddress = addressM.fullAddress;
    String? city = addressM.city;
    String? pinCode = addressM.pincode;
    String? type = addressM.type;
    bool isDefault = addressM.isDefault ?? false;
    String cityPinCode = '${city ?? 'Unknown City'} ${pinCode ?? '000000'}';
    type = '${type ?? 'Other'}';
    if(fullAddress == null){
