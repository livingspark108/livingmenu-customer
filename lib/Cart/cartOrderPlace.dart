...
class CartOrderPlace extends StatefulWidget {
  CartOrderPlace({Key? key, required this.latLong}) : super(key: key);

  LatLng latLong;

  @override
  State<CartOrderPlace> createState() => _CartOrderPlaceState();
}

class _CartOrderPlaceState extends State<CartOrderPlace>{
  late double w, h;
                                  ...
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: (){
                                        ...
                                        Navigator.push(context, AnimatedRoute.createRouteRightToLeft(TakeawayTime()));
                                      },
                                      child: Container(
                                        width: w * 0.44,
                                        height: h * 0.125,
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            Container(
                                              width: w * 0.05,
                                                child: SvgPicture.asset('assets/icons/home_black.svg')
                                            ),
                                            SizedBox(width: w * 0.04,),
                                            Column(
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text('B 163, Shivraj Niketan Colony',
                                                  style: TextStyle(
                                                      fontWeight: FontWeight.w500,
                                                      fontSize: fontSizes.fontSize14,
                                                      fontFamily: 'Poppins_regular',
                                                ...
                                                Text('Vaishali Nagar, Jaipur - 302021',
                                                  style: TextStyle(
                                                      fontWeight: FontWeight.w600,
                                                      fontSize: fontSizes.fontSize12,
                                                      fontFamily: 'Poppins_regular',
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          Navigator.push(context, AnimatedRoute.createRouteRightToLeft(TrackOrder(latLong: _userLatLong)));
                        },
                        child: Container(
                          height: h * 0.06,
                          width: w,
