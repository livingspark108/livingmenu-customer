...
import 'package:living_menu_mobile/BookParty/partyCheckout.dart';

import '../Constants/animatedRoute.dart';
import '../Constants/appFontSizes.dart';

class PartySelectAdditionalItems extends StatefulWidget {
  const PartySelectAdditionalItems({super.key});

  @override
  State<PartySelectAdditionalItems> createState() => _PartySelectAdditionalItems();
}

class _PartySelectAdditionalItems extends State<PartySelectAdditionalItems> {
  late double w, h;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.push(context, AnimatedRoute.createRouteRightToLeft(PartyCheckout()));
                          },
                          child: Container(
                            width: w,
                            decoration: BoxDecoration(
