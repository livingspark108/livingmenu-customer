...
import 'package:living_menu_mobile/BookParty/partyBookingPackageDescription.dart';

import '../Constants/animatedRoute.dart';
import '../Constants/appFontSizes.dart';

class PartyBookingHallDetails extends StatefulWidget {
  const PartyBookingHallDetails({super.key});

  @override
  State<PartyBookingHallDetails> createState() => _PartyBookingHallDetailsState();
}

class _PartyBookingHallDetailsState extends State<PartyBookingHallDetails>{
  late double w, h;
  @override
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          Navigator.push(context, AnimatedRoute.createRouteRightToLeft(PartyBookingPackageDescription()));
                        },
                        child: Container(
                          height: h * 0.06,
                          width: w,
