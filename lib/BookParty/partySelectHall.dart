...
import 'package:living_menu_mobile/BookParty/allPartyBooking.dart';
import 'package:living_menu_mobile/BookParty/partyBookingHallDetails.dart';
import 'package:living_menu_mobile/BookParty/partySelectPackage.dart';
import 'package:living_menu_mobile/Constants/animatedRoute.dart';

import '../Constants/appFontSizes.dart';

class PartySelectHall extends StatefulWidget {
  const PartySelectHall({super.key});

  @override
  State<PartySelectHall> createState() => _PartySelectHallState();
}

class _PartySelectHallState extends State<PartySelectHall>{
  late double w, h;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        GestureDetector(
                          onTap: (){
                            Navigator.push(context, AnimatedRoute.createRouteRightToLeft(AllPartyBooking()));
                          },
                          child: Container(
                            decoration: BoxDecoration(
                              color: Colors.black,
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.push(context, AnimatedRoute.createRouteRightToLeft(PartySelectPackage()));
                          },
                          child: Container(
                            decoration: BoxDecoration(
                              color: Color(0xFF001FFF),
