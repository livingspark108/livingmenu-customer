...
class PartySelectFood extends StatefulWidget {
  const PartySelectFood({super.key});

  @override
  State<PartySelectFood> createState() => _PartySelectFood();
}

class _PartySelectFood extends State<PartySelectFood> {
  late double w, h;
