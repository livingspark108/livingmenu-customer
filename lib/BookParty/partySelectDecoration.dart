...
import 'package:living_menu_mobile/BookParty/partySelectAdditionalItems.dart';

import '../Constants/animatedRoute.dart';
import '../Constants/appFontSizes.dart';

class PartySelectDecoration extends StatefulWidget {
  const PartySelectDecoration({super.key});

  @override
  State<PartySelectDecoration> createState() => _PartySelectDecoration();
}

class _PartySelectDecoration extends State<PartySelectDecoration> {
  late double w, h;
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: (){
                            Navigator.push(context, AnimatedRoute.createRouteRightToLeft(PartySelectAdditionalItems()));
                          },
                          child: Container(
                            width: w,
                            decoration: BoxDecoration(
